  ...
  return (
    <div>
      <aside
        ...
        className="w-[250px] h-screen transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto  bg-gray-800">
          <img
            src="https://th.bing.com/th/id/OIP.afQdiNPi7rhMZnP6xqoyLwHaHa?rs=1&pid=ImgDetMain"
            alt=""
          ...
          <a
            href="#"
            className="flex items-center p-2  rounded-lg text-white absolute bottom-10 hover:bg-gray-700 group"
          >
