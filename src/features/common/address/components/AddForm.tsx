...
const ListAddressSelect = (): React.ReactElement => {
  const [open, setOpen] = React.useState(false);
  ...
  React.useEffect(() => {
    setAddress(`${province ? province.name : "Tỉnh/ Thành phố"}, ${district ? district.name : "Quận/Huyện"}, Phường/Xã"`);
    ...
    <div className="mb-4">
      ...
      <div className="relative">
        ...
        >
          ...
          {showList === 2 && (
            <ListWard setWard={setWard} setShowList={setShowList} data={district} setOpen={setOpen}/>
          )}
        </div>
      </div>
    </div>
