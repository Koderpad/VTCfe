...
export const VariantsImage = ({ existsImage, setImageUrl }: Props) => {
  ...
  return (
    ...
    <div id="edit-row" className=" object-fill">
      {/* content */}
      <div id="edit-main image-offset" className="-mb-[16px]">
        ...
        {/* Show a full page modal with the spinner when the image is being uploaded */}
        <Modal
          isOpen={isUploading}
          style={{
            overlay: {
