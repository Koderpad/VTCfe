...
} from "../../../redux/api/updateProductApi";
import {
  GetProductDetailApiResponse,
  ProductVariantDTO,
} from "./interfaces/GetProductDetailResponsesBody";
...
} from "./interfaces/UpdateProductRequestBody.ts";
...
export const UpdateProductEdit = () => {
  ...
  const [productVariantRequests, setProductVariantRequests] = useState<
    ProductVariantRequest[]
  >([]);

  const [productVariantDTOs, setProductVariantDTOs] = useState<
    ProductVariantDTO[]
  >([]);
  ...
  const fetchData = async () => {
    ...
    if (productDetail) {
      ...
      setProductVariantDTOs(
        productDetailResponse.productDTO.productVariantDTOs
      );
    } else {
