import { useAddNewCategoryByAdminMutation } from "../../features/admin/redux/api/categoryAdminApi";
...
const AddParentCategory = () => {
  ...
  const [categoryAdminRequest, setCategoryAdminRequest] =
    useState<CategoryAdminRequest>({
      categoryId: 0,
      name: "",
      description: "",
      image: "",
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    try {
      const response = await callApiAddParentCategory(
        categoryAdminRequest
      ).unwrap();
