import {
    ...
    useGetVoucherShopByVoucherIdMutation, useUpdateVoucherShopMutation
...
} from "../../features/admin/redux/api/voucherAdminApi.ts";
...
const UpdateVoucherAdmin = () => {
    ...
    const [callGetVoucherShopByVoucherId] = useGetVoucherAdminByVoucherIdMutation();
    const [callApiUpdateVoucherShop] = useUpdateVoucherAdminMutation();

    const navigate = useNavigate();
    const [voucherShopRequest, setVoucherShopRequest] = useState<VoucherShopRequest>({
        voucherId: 0,
        code: "",
        name: "",
        description: "",
    ...
    const handleGetVoucherShopByVoucherId = async (e: { preventDefault: () => void; } | undefined) => {
        ...
        try {
            ...
            console.log("voucherShopRequestvoucherShopRequestvoucherShopRequest", voucherShopRequest)
    ...
    const handleSubmit = async (e: any) => {
        ...
        await callApiUpdateVoucherShop(voucherShopRequest)
            ...
            .then((res) => {
                console.log(res);
                navigate("/vendor/admin/vouchers");
            })
    ...
    return (
        <div className="container mx-auto p-8">
            ...
            <form onSubmit={handleSubmit} className="max-w-md mx-auto">
                ...
                <div className="mb-4">
                    ...
                    <select
                        name="type"
                        id="type"
                        value={voucherShopRequest.type === 'Giảm theo tiền' ? "money" : "percent"  }
            ...
            <br/>
            <div>
                <button className={"justify-center"} onClick={() => navigate("/admin/vouchers")}>
                    Quay lại
                </button>
            </div>
