...
const Review = () => {
  ...
  const [orderItemResponse, setOrderItemResponse] =
        ...
        <table className="w-full border-collapse mt-4">
          ...
          <tbody>
            <tr>
              ...
              <td className="border px-4 py-2">
                <img
                  src={orderItemResponse?.productImage}
                  alt="product"
                  className="w-20 h-20"
                />
              </td>
              ...
              <td className="border px-4 py-2">
                {" "}
                {orderItemResponse?.price * orderItemResponse?.quantity}
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table className="w-full border-collapse mt-4">
          ...
          <tbody>
            <tr>
              <td className="border px-4 py-2">
                {" "}
                {reviewResponse?.reviewDTO.content}
              </td>
              <td className="border px-4 py-2">
                {" "}
                {reviewResponse?.reviewDTO.rating}
              </td>
              <td className="border px-4 py-2">
                {reviewResponse?.reviewDTO.image !== "" ? (
                  <img
                    src={reviewResponse?.reviewDTO.image}
                    alt="product"
                    className="w-20 h-20"
                  />
                ) : (
