...
const Statistical: React.FC = () => {
  ...
  const getTotalDaysWithOrders = (): number => {
    ...
    return statisticsResponse.statisticsDTOs.filter(
      (statistic) => statistic.totalOrder > 0
    ).length;
  };
          ...
          <div className="mt-8">
            ...
            <div className="flex space-x-4 mb-4 justify-end">
              ...
              <div className="flex items-center">
                ...
                <span>
                  Tổng Ngày Không Có Đơn: {getTotalDaysWithoutOrders()}
                </span>
              </div>
              <div className="flex items-center">
