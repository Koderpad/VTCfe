...
const VouchersShop = () => {
    ...
    const [callGetListVoucherShop] = useGetAllVoucherShopMutation();
    ...
    const handleAddNewVoucherShop =  (e) => {
        e.preventDefault();
        navigation("/vendor/shop/voucher/add");
    }
    ...
    return (
        <div className="container mx-auto p-8">
            <h1 className="text-3xl font-bold mb-4">Quản Lý Voucher Của Cửa Hàng </h1>
            <button
                    ...
                    <tr key={index}>
                        ...
                        <td className="p-2">
                            <button
                                ...
                                onClick={() => navigation(`/vendor/shop/voucher/edit/${voucher.voucherId}`)}
                            >
                                Cập nhật
                            </button>
                        </td>
